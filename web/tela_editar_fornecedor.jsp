...
<html>
    ...
    <body>
        ...
        <form action="executar_editar_fornecedor.jsp" method="post">


            <input name="id_fornecedor" required="required" type="text" value="<%=request.getParameter("id_fornecedor")%>" style="display:none; visibility:hidden;"/>
